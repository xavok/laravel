<div class="panel panel-default">
    <div class="panel-body">
        ...
        <form id="education_form" method="post" action="#">
            ...
            <button class="btn btn-default" type="button" id="addIndustry" style="margin-top: 10px;">Add more
            </button>
            <div class="input-group" style="width: 100%;">
                <input type="submit" value="Next" name="INsubmit" class="btn btn-default buttonNext" style="margin-left:10px">
            </div>
        </form>
    </div>
</div>
